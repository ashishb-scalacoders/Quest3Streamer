    ...
    public class GameViewDecoder_Editor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                if (!GVDecoder.EditorShowSettings || !drawSuccess)
                {
            ...
            GUILayout.BeginVertical("box");
            {
                if (!GVDecoder.EditorShowDecoded || !drawSuccess)
                {
                    GUILayout.BeginHorizontal();
                    GUI.skin.button.alignment = TextAnchor.MiddleLeft;
            ...
            GUILayout.BeginVertical("box");
            {
                if (!GVDecoder.EditorShowDesktopFrameInfo || !drawSuccess)
                {
                    GUILayout.BeginHorizontal();
                    GUI.skin.button.alignment = TextAnchor.MiddleLeft;
            ...
            GUILayout.BeginVertical("box");
            {
                if (!GVDecoder.EditorShowPairing || !drawSuccess)
                {
                    GUILayout.BeginHorizontal();
                    GUI.skin.button.alignment = TextAnchor.MiddleLeft;
