    ...
    public class GameViewEncoder_Editor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                if (!GVEncoder.EditorShowMode || !drawSuccess)
                {
            ...
            GUILayout.BeginVertical("box");
            {
                if (!GVEncoder.EditorShowSettings || !drawSuccess)
                {
                    GUILayout.BeginHorizontal();
                    GUI.skin.button.alignment = TextAnchor.MiddleLeft;
            ...
            GUILayout.BeginVertical("box");
            {
                if (!GVEncoder.EditorShowNetworking || !drawSuccess)
                {
                    GUILayout.BeginHorizontal();
                    GUI.skin.button.alignment = TextAnchor.MiddleLeft;
            ...
            GUILayout.BeginVertical("box");
            {
                if (!GVEncoder.EditorShowEncoded || !drawSuccess)
                {
                    GUILayout.BeginHorizontal();
                    GUI.skin.button.alignment = TextAnchor.MiddleLeft;
                ...
                else
                {
                    ...
                    GUILayout.BeginVertical("box");
                    {
                        ...
                        if (GVEncoder.OutputFormat == GameViewOutputFormat.FMMJPEG || GVEncoder.OutputFormat == GameViewOutputFormat.MJPEG)
                        {
                            GUILayout.BeginHorizontal();
            ...
            GUILayout.BeginVertical("box");
            {
                if (!GVEncoder.EditorShowPairing || !drawSuccess)
                {
                    GUILayout.BeginHorizontal();
                    GUI.skin.button.alignment = TextAnchor.MiddleLeft;
